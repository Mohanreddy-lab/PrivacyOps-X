        ...
        task_cards.append(
            {
                ...
                "focus": {
                    ...
                    "fable": "Contradictory identity claims, synthetic fraud, and executor-guardian paradox resolution.",
                    "mythos": "Sanctioned entity denial, whistleblower preservation, and regulatory subpoena cascade.",
                    "god": "Forged warrant detection, contaminated audit trail containment, and impersonation incident response.",
                    "irreducible": "Constitutional regulatory deadlock recognition, multi-jurisdictional conflict escalation, and cross-record synthesis under temporal pressure.",
                }.get(task["difficulty"], "Unknown difficulty — advanced multi-constraint resolution required."),
                "drills": [
